...
if __name__ == "__main__":
    ...
    # python data/04c_enzymaticXtoY_enzymaticYtoZ_3InnerBoundaries_modifyingPositionOf1EnzymeRegion_modifyingKm_AInside/analysis.py data/04c_enzymaticXtoY_enzymaticYtoZ_3InnerBoundaries_modifyingPositionOf1EnzymeRegion_modifyingKm_AInside