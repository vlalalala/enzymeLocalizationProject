...
if __name__ == "__main__":
    ...
    # python data/04a_enzymaticXtoY_enzymaticYtoZ_3_innerBoundaries_modifyingPositionOf1EnzymeRegion_AOutside/analysis.py data/04a_enzymaticXtoY_enzymaticYtoZ_3_innerBoundaries_modifyingPositionOf1EnzymeRegion_AOutside