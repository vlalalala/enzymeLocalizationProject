...
def plot_data(folder):
    ...
    df = df.sort_values("x")
    ax.plot(df["x"], df["flux"])

    ax.set_xlabel(r"relative radius of innermost membrane $r_1/R$")
    ax.set_ylabel(r"flux with 1 inner membrane divided by flux without membrane /  $j_X / j_X(r_1=0)$")
...
if __name__ == "__main__":
    ...
    # python data/01_spontaneousXtoY_1InnerBoundary_modifyingInnerRadius/analysis.py data/01_spontaneousXtoY_1InnerBoundary_modifyingInnerRadius