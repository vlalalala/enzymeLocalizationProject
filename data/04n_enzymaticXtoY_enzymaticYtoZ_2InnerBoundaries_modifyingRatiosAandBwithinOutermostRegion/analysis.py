...
def plot_data(folder):
    ...
    for external_concentration in X_external_concentrations:
        ...
        print(external_concentration, x_of_max_flux)
        #print(x_of_max_flux)
...
# python data/04n_enzymaticXtoY_enzymaticYtoZ_2InnerBoundaries_modifyingRatiosAandBwithinOutermostRegion/analysis.py data/04n_enzymaticXtoY_enzymaticYtoZ_2InnerBoundaries_modifyingRatiosAandBwithinOutermostRegion