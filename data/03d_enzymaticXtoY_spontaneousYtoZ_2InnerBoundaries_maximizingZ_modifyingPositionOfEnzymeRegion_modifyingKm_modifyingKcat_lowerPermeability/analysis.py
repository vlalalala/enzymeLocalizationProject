...
if __name__ == "__main__":
    ...
    # python data/03d_enzymaticXtoY_spontaneousYtoZ_2InnerBoundaries_maximizingZ_modifyingPositionOfEnzymeRegion_modifyingKm_modifyingKcat_lowerPermeability/analysis.py data/03d_enzymaticXtoY_spontaneousYtoZ_2InnerBoundaries_maximizingZ_modifyingPositionOfEnzymeRegion_modifyingKm_modifyingKcat_lowerPermeability