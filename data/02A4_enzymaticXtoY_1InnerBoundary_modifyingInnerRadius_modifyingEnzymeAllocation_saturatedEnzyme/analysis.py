    ...
    for folder_name in os.listdir(folder):
        ...
        if match:
            ...
            if os.path.isfile(fluxes_file):
                ...
                Y_flux = None
            data[index] = (internal_relative_radius, allocation_in_external, Y_flux, X_external_concentration,index)
    return data
...
if __name__ == "__main__":
    ...
    # python data/02A4_enzymaticXtoY_1InnerBoundary_modifyingInnerRadius_modifyingEnzymeAllocation_saturatedEnzyme/analysis.py data/02A4_enzymaticXtoY_1InnerBoundary_modifyingInnerRadius_modifyingEnzymeAllocation_saturatedEnzyme
