...
def plot_data(folder):
    ...
    for Kcat_idx, Kcat_value in enumerate(Kcat):
        ...
        ax.plot(current_df["inner_radius"], current_df["flux"], label = "{:.2E}".format(Kcat_value))
...
if __name__ == "__main__":
    ...
    # python data/05f_spontaneousXtoY_enzymaticYtoZ_2InnerBoundaries_modifyingPositionOfEnzymeRegion_modifyingKcat_lowPermeability/analysis.py data/05f_spontaneousXtoY_enzymaticYtoZ_2InnerBoundaries_modifyingPositionOfEnzymeRegion_modifyingKcat_lowPermeability