...
if __name__ == "__main__":
    ...
    # python data/04j_enzymaticXtoY_enzymaticYtoZ_2InnerBoundaries_modifyingRatiosAandBwithinOutermostRegion/analysis.py data/04j_enzymaticXtoY_enzymaticYtoZ_2InnerBoundaries_modifyingRatiosAandBwithinOutermostRegion 