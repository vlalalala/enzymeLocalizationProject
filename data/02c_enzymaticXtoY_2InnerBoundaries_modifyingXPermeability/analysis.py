...
def get_data(folder):
    ...
    for folder_name in os.listdir(folder):
        ...
        if match:
            ...
            x_axis_value = species_df.loc[(species_df["name"] == "X"), "permeability_constant"].item()
...
def plot_data(folder):
    ...
    ax.set_xlabel("permeability of species X")
    ax.set_ylabel("flux")
    ax.set_xscale("log")
    ax.set_yscale("log")
...
if __name__ == "__main__":
    ...
    # python data/02c_enzymaticXtoY_2InnerBoundaries_modifyingXPermeability/analysis.py data/02c_enzymaticXtoY_2InnerBoundaries_modifyingXPermeability