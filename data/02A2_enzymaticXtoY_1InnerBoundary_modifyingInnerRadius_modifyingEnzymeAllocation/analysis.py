...
if __name__ == "__main__":
    ...
    # python data/02A2_enzymaticXtoY_1InnerBoundary_modifyingInnerRadius_modifyingEnzymeAllocation/analysis.py data/02A2_enzymaticXtoY_1InnerBoundary_modifyingInnerRadius_modifyingEnzymeAllocation